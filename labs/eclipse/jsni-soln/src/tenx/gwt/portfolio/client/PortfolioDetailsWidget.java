...
public class PortfolioDetailsWidget extends Composite implements ClickHandler {
	...
	native void publish() /*-{
		var that = this;
		$wnd.refreshPortfolio = function() {
			$wnd.alert("refreshing portfolio with id "
				+ that.@tenx.gwt.portfolio.client.detail.PortfolioDetailsViewImpl::portFolioId);
			that.@tenx.gwt.portfolio.client.detail.PortfolioDetailsViewImpl::refresh();
		}	
	}-*/;
