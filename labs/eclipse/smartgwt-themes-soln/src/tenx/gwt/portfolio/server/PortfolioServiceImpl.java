...
public class PortfolioServiceImpl extends RemoteServiceServlet implements
	...
	@Override
	public void updateEntry(Integer portfolioId, PortfolioEntry newEntry)
			throws PortfolioNotFoundException {
		try {
			BeanUtils.copyProperties(getPortfolioDetail(portfolioId).getEntries().lastIndexOf(newEntry),newEntry);
		} catch (Exception e) {
