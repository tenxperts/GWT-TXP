...
public class PortfolioDetailsWidget extends Composite implements ClickHandler {
	...
	public PortfolioDetailsWidget(int portfolioId) {
		...
		ButtonItem validateButton = new ButtonItem("validate", "Validate");
		
		validateButton.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler() {
			@Override
			public void onClick(
					com.smartgwt.client.widgets.form.fields.events.ClickEvent event) {
				portfolioEntryEditForm.validate();
			}
		});
		...
		saveButtonItem.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler() {
			...
			public void onClick(
					com.smartgwt.client.widgets.form.fields.events.ClickEvent event) {
				portfolioEntryEditForm.saveData();
			}
		});
		
		ButtonItem resetButton = new ButtonItem("reset","Reset");
		...
		resetButton.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler() {
			...
			public void onClick(
					com.smartgwt.client.widgets.form.fields.events.ClickEvent event) {
				portfolioEntryEditForm.reset();
			}
		});
		
		
		portfolioEntryEditForm.setDataSource(portfolioEntryDataSource);
		portfolioEntryEditForm.setValidateOnChange(true);
