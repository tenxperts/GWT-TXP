...
public class PortfolioEntryDataSource extends GwtRpcDataSource {
	...
	public PortfolioEntryDataSource(Integer portfolioId) {
		...
		DataSourceIntegerField quantityField = new DataSourceIntegerField(GRID_FIELD_QUANTITY, "Quantity");
		IntegerRangeValidator quantityRangeValidator = new IntegerRangeValidator();
		quantityRangeValidator.setMin(1);
		quantityField.setValidators(quantityRangeValidator);
		quantityField.setRequired(true);
		
		DataSourceTextField symbolField = new DataSourceTextField(GRID_FIELD_SYMBOL, "Symbol");
		LengthRangeValidator symbolLengthValidator = new LengthRangeValidator();
		symbolLengthValidator.setMin(3);
		symbolLengthValidator.setMax(10);
		symbolField.setRequired(true);
		symbolField.setValidators(symbolLengthValidator);
