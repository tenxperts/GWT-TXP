...
public class PortfolioListWidget extends Composite {
				...
				for(final PortfolioLite portfolio:portfolios) {
					...
					portfolioLink.addClickHandler(new ClickHandler() {
						...
						public void onClick(ClickEvent event) {
							getMainPanel().setWidget(new PortfolioDetailsWidget(portfolio.getId()));
						}
					});
	...
	private SimplePanel getMainPanel() {
		return (SimplePanel)PortfolioListWidget.this.getParent();
	}
